	...
	const EntityUploadInfo* upload_info)
{
	...
	vkpt_pt_create_dynamic(cmd_buf, qvk.current_frame_index,
		qvk.buf_vertex_model_dynamic.address + offsetof(ModelDynamicVertexBuffer, positions_instanced), upload_info->dynamic_vertex_num);

	vkpt_pt_create_transparent_models(cmd_buf, qvk.current_frame_index,
		qvk.buf_vertex_model_dynamic.address + offsetof(ModelDynamicVertexBuffer, positions_instanced), upload_info->transparent_model_vertex_num,
		upload_info->transparent_model_vertex_offset);

	vkpt_pt_create_viewer_models(cmd_buf, qvk.current_frame_index,
		qvk.buf_vertex_model_dynamic.address + offsetof(ModelDynamicVertexBuffer, positions_instanced), upload_info->viewer_model_vertex_num,
		upload_info->viewer_model_vertex_offset);

	vkpt_pt_create_viewer_weapon(cmd_buf, qvk.current_frame_index,
		qvk.buf_vertex_model_dynamic.address + offsetof(ModelDynamicVertexBuffer, positions_instanced), upload_info->viewer_weapon_vertex_num,
		upload_info->viewer_weapon_vertex_offset);

	vkpt_pt_create_explosions(cmd_buf, qvk.current_frame_index,
		qvk.buf_vertex_model_dynamic.address + offsetof(ModelDynamicVertexBuffer, positions_instanced), upload_info->explosions_vertex_num,
